...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contactList.add(new ContactDetails("Ravi", "1111111111"));
        contactList.add(new ContactDetails("Raja", "2222222222"));
        contactList.add(new ContactDetails("Rajeev", "3333333333"));
        contactList.add(new ContactDetails("Sanjeev", "444444444"));
        contactList.add(new ContactDetails("Ankit", "5555555555"));
